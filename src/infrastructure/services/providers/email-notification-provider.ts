...
import { EmailTemplateService, EmailTemplateType, SchedulingTemplateData } from '../templates/email-templates.js';
...
export class EmailNotificationProvider implements NotificationProvider {
  ...
  async send(notification: Notification): Promise<void> {
    try {
      ...
      if (!schedulingData) {
        throw new Error(`Não foi possível encontrar os dados do agendamento ${notification.schedulingId}`);
      }
