...
describe("RecurringTimePeriod", () => {
	...
	describe("createFromDaysOfWeek", () => {
		it("should create a recurring time period from days of week", () => {
			...
			expect(recurringPeriod.getDaysOfWeek()).toEqual([
				DayOfWeek.MONDAY,
				DayOfWeek.WEDNESDAY,
				DayOfWeek.FRIDAY,
			]);
	...
	describe("excludeDays", () => {
		it("should return new recurring period with excluded days", () => {
			...
			expect(result.getDaysOfWeek()).toEqual([
				DayOfWeek.MONDAY,
				DayOfWeek.WEDNESDAY,
				DayOfWeek.FRIDAY,
			]);
	...
	describe("toString", () => {
		...
		it("should format string representation in 12h format", () => {
			const period = RecurringTimePeriod.createFromDaysOfWeek([DayOfWeek.MONDAY], "09:00", "17:00");
