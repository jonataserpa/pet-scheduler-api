...
describe('User', () => {
  describe('create', () => {
    ...
    it('should throw error if email is empty', async () => {
      ...
      ).rejects.toThrow('User: Email é obrigatório');
    });
    ...
    it('should throw error if email is invalid', async () => {
      ...
      ).rejects.toThrow('User: Email inválido');
    });
    ...
    it('should throw error if password is too short', async () => {
      ...
      ).rejects.toThrow('User: Senha deve ter pelo menos 8 caracteres');
    });
    ...
    it('should throw error if name is empty', async () => {
      ...
      ).rejects.toThrow('User: Nome é obrigatório');
    });
  });
  ...
  describe('changePassword', () => {
    ...
    it('should throw error if current password is incorrect', async () => {
      ...
      await expect(
        user.changePassword('wrong_password', 'newpassword123')
      ).rejects.toThrow('User: Senha atual inválida');
    });
    ...
    it('should throw error if new password is too short', async () => {
      ...
      await expect(
        user.changePassword('password123', '123')
      ).rejects.toThrow('User: Nova senha deve ter pelo menos 8 caracteres');
    });
  });
