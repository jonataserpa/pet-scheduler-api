...
export class Appointment {
  ...
  public changeStatus(status: AppointmentStatus): void {
    ...
    if (
      ...
      throw new Error('Appointment: um agendamento com falta só pode ser remarcado (status SCHEDULED)');
    }
  ...
  public confirm(): void {
    if (this._status !== AppointmentStatus.SCHEDULED) {
      throw new Error('Appointment: apenas agendamentos com status SCHEDULED podem ser confirmados');
    }
  ...
  public complete(): void {
    if (
      ...
      throw new Error('Appointment: apenas agendamentos agendados ou confirmados podem ser concluídos');
    }
  ...
  public markAsNoShow(): void {
    if (
      ...
      throw new Error('Appointment: apenas agendamentos agendados ou confirmados podem ser marcados como no-show');
    }
