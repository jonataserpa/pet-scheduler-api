...
export class User {
  ...
  public static async create(
    ...
    if (!Object.values(UserRole).includes(role)) {
      throw new Error(`User: Role inválido. Deve ser um dos valores: ${Object.values(UserRole).join(', ')}`);
    }
   ...
   */
  public async changePassword(currentPassword: string | null, newPassword: string, skipValidation: boolean = false): Promise<void> {
