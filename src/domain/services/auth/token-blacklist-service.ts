...
export class TokenBlacklistService {
	...
	public async connect(): Promise<void> {
		try {
			...
			throw new Error(
				`TokenBlacklistService: Erro ao conectar ao Redis: ${(error as Error).message}`,
			);
		}
	}
	...
	public async disconnect(): Promise<void> {
		try {
			...
			throw new Error(
				`TokenBlacklistService: Erro ao desconectar do Redis: ${(error as Error).message}`,
			);
		}
	}
	...
	public async addToBlacklist(
		...
		try {
			...
			throw new Error(
				`TokenBlacklistService: Erro ao adicionar token à blacklist: ${(error as Error).message}`,
			);
		}
	}
	...
	public async isBlacklisted(token: string): Promise<boolean> {
		try {
			...
			throw new Error(
				`TokenBlacklistService: Erro ao verificar token na blacklist: ${(error as Error).message}`,
			);
		}
	}
	...
	public async removeFromBlacklist(token: string): Promise<void> {
		try {
			...
			throw new Error(
				`TokenBlacklistService: Erro ao remover token da blacklist: ${(error as Error).message}`,
			);
		}
	}
	...
	public async getBlacklistReason(token: string): Promise<string | null> {
		try {
			...
			throw new Error(
				`TokenBlacklistService: Erro ao obter razão do token na blacklist: ${(error as Error).message}`,
			);
		}
	}
	...
	public async addMultipleToBlacklist(
		...
		try {
			...
			throw new Error(
				`TokenBlacklistService: Erro ao adicionar múltiplos tokens à blacklist: ${(error as Error).message}`,
			);
		}
	}
