...
export class UpdateCustomerUseCase {
   ...
   */
  private createUpdatedAddress(currentAddress: Address, request: UpdateCustomerRequest): Result<Address> {
    try {
      ...
      return Result.ok(Address.create(
   ...
   */
  private createUpdatedContact(currentContact: Contact, request: UpdateCustomerRequest): Result<Contact> {
    try {
      ...
      return Result.ok(Contact.create(
