...
export function setupSchedulingRoutes(
	 ...
	 */
	router.get("/", authenticate, schedulingController.listSchedulings.bind(schedulingController));
	 ...
	 *         description: Erro interno do servidor
	 */
	router.post("/", authenticate, schedulingController.createScheduling.bind(schedulingController));
