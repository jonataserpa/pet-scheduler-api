...
export class WhatsAppNotificationController {
  ...
  async sendSchedulingConfirmation(req: Request, res: Response): Promise<void> {
    try {
      ...
      res.status(500).json({
        status: 'error',
        message: error instanceof Error ? error.message : 'Erro ao enviar mensagem WhatsApp de confirmação',
      });
    }
  }
  ...
  async sendSchedulingReminder(req: Request, res: Response): Promise<void> {
    try {
      ...
      res.status(500).json({
        status: 'error',
        message: error instanceof Error ? error.message : 'Erro ao enviar mensagem WhatsApp de lembrete',
      });
    }
  }
  ...
  async sendSchedulingCancellation(req: Request, res: Response): Promise<void> {
    try {
      ...
      res.status(500).json({
        status: 'error',
        message: error instanceof Error ? error.message : 'Erro ao enviar mensagem WhatsApp de cancelamento',
      });
    }
  }
  ...
  async sendSchedulingRescheduled(req: Request, res: Response): Promise<void> {
    try {
      ...
      res.status(500).json({
        status: 'error',
        message: error instanceof Error ? error.message : 'Erro ao enviar mensagem WhatsApp de reagendamento',
      });
    }
  }
} 