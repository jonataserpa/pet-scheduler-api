...
export class EmailNotificationController {
  ...
  async sendSchedulingConfirmation(req: Request, res: Response): Promise<void> {
    try {
      const { schedulingId, customerName, petName, serviceName, dateTime, additionalInfo } = req.body;
  ...
  async sendSchedulingCancellation(req: Request, res: Response): Promise<void> {
    try {
      const { schedulingId, customerName, petName, serviceName, dateTime, cancellationReason } = req.body;
